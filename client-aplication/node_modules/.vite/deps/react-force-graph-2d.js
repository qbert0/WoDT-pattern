...
function L(n2, l2, u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  ...
  for (f2 = T(u2, l2, m3, f2, b10), s2 = 0; s2 < b10; s2++)
...
function O(n2, l2, u2, t3) {
  ...
  if (null === c5 && null == e2 || a3 && e2 == c5.key && f2 == c5.type)
    return u2;
  if (t3 > (a3 ? 1 : 0)) {
...
function q(n2, u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  ...
  n:
    if ("function" == typeof j2) {
      ...
      null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = G(t3.__e, u2, t3, i2, r2, o2, e2, c5, a3);
...
function G(u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  ...
  if (null == x3)
    ...
    if (e2 = "textarea" == x3 && null != k2.defaultValue ? null : e2 && n.call(u2.childNodes), !c5 && null != e2)
    ...
    for (s2 in k2)
      y3 = k2[s2], "children" == s2 ? v2 = y3 : "dangerouslySetInnerHTML" == s2 ? h2 = y3 : "value" == s2 ? w2 = y3 : "checked" == s2 ? _2 = y3 : c5 && "function" != typeof y3 || m3[s2] === y3 || N(u2, s2, y3, m3[s2], o2);
    if (h2)
      c5 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && $(i2, 0), c5, a3), null != e2)
      for (s2 = e2.length; s2--; )
        b(e2[s2]);

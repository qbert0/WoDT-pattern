...
function O(n2, l2, u2, t3) {
  ...
  if (null === c5 && null == e2 || s2 && e2 == c5.key && f2 == c5.type)
    return u2;
  if (t3 > (s2 ? 1 : 0)) {
...
function N(n2, l2, u2, t3, i2) {
  ...
  n:
    if ("style" == l2)
      ...
      r2 = l2 != (l2 = l2.replace(a, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t3 ? u2[s] = t3[s] : (u2[s] = h, n2.addEventListener(l2, r2 ? v : p, r2)) : n2.removeEventListener(l2, r2 ? v : p, r2);
    else {
    ...
    if ("function" == typeof T2)
      try {
        ...
        if (u2.__v = null, c5 || null != o2)
          ...
          u2.__e = t3.__e, u2.__k = t3.__k, n3.then || B(u2);
        l.__e(n3, u2, t3);
      }
    else
      null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = G(t3.__e, u2, t3, i2, r2, o2, e2, c5, s2);
...
function G(u2, t3, i2, r2, o2, e2, f2, c5, s2) {
  ...
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e2) {
    for (a3 = 0; a3 < e2.length; a3++)
      if ((y3 = e2[a3]) && "setAttribute" in y3 == !!x3 && (x3 ? y3.localName == x3 : 3 == y3.nodeType)) {
        u2 = y3, e2[a3] = null;
        break;
      }
  }
  ...
  if (null == x3)
    ...
    if (e2 = e2 && n.call(u2.childNodes), !c5 && null != e2)
    ...
    if (h2)
      c5 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && $(i2, 0), c5, s2), null != e2)
      for (a3 = e2.length; a3--; )
        b(e2[a3]);

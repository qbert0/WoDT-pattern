...
class Settings:
    ...
    mqtt_host: str = os.getenv("MQTT_HOST", os.getenv("DITTO_MQTT_HOST", "34.143.166.45"))
    ...
    ditto_mqtt_host: str = os.getenv("DITTO_MQTT_HOST", os.getenv("MQTT_HOST", "34.143.166.45"))
